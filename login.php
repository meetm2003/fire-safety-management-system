...
<body>
          <div class="header">
            ...
            <a class="active" href="index.html">Back</a>  
              <a class="active" href="register.php"  style="margin-right:20px;">REGISTER</a>  
            </div>
          </div>

  <form name="input" action="logindata.php" method="post">
  <h3>Login Here</h3>
  ...
  <label for="password">Password:</label><input type="password" value="" placeholder="password" id="password" name="password" />
    <input class="home" type="submit" value="Login" name="sub" />
  </form>
</body>
</html>