...
.header {
    ...
    <a href="#default" class="logo">Fire Safety</a>
            <div class="header-right">
              ...
              <a class="active" href="home.php"  style="margin-right:20px;">HOME</a>
              <a class="active" href="vendor.php"  style="margin-right:20px;">NEW VENDOR</a>
              <a class="active" href="product.php">NEW PRODUCT</a>
        ...
        <table style="width: 100%;">
            ...
            <form action="a3.php" method="post">
                <!-- <tbody id="tbody"> -->
                    ...
                    <datalist id="dn">
                            <?php $conn = mysqli_connect("localhost", "root", "", "id20230661_myoffice");
                            // session_start();
                            // Check connection
                            if($conn === false){
