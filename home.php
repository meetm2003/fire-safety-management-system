...
.header {
    ...
    <div class="header">
            ...
            <div class="header-right">
              <a class="active" href="view.php" style="margin-right:20px;">VIEW CUSTOMER HISTORY</a>
              <a class="active" href="a1.php" style="margin-right:20px;">NEW CUSTOMER</a>
              <a class="active" href="expenses-profit.php" style="margin-right:20px;">EXPENSES-INCOME</a>
